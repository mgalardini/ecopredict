...
$(FIGUREB): $(SCHEMESICKNESS) $(ESSENTIALPLOT) $(CORRELATIONPLOT) $(ROCPLOT) $(ANNOTATIONPLOT)
	$(SRCDIR)/run_figure_b $(SCHEMESICKNESS) $(ESSENTIALPLOT) $(CORRELATIONPLOT) $(ROCPLOT) $(ANNOTATIONPLOT) $@
$(FIGUREBCORE): $(SCHEMESICKNESS) $(ESSENTIALPLOT) $(CORRELATIONPLOT1) $(ROCPLOT1) $(ANNOTATIONPLOT1)
	$(SRCDIR)/run_figure_b $(SCHEMESICKNESS) $(ESSENTIALPLOT) $(CORRELATIONPLOT1) $(ROCPLOT1) $(ANNOTATIONPLOT1) $@
$(FIGUREBACC): $(SCHEMESICKNESS) $(ESSENTIALPLOT) $(CORRELATIONPLOT2) $(ROCPLOT2) $(ANNOTATIONPLOT2)
	$(SRCDIR)/run_figure_b $(SCHEMESICKNESS) $(ESSENTIALPLOT) $(CORRELATIONPLOT2) $(ROCPLOT2) $(ANNOTATIONPLOT2) $@
